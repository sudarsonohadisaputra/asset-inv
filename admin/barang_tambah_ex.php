          ...
          <div class="box-body">
            <form action="barang_act.php" method="post">
              <div class="form-group">
                <label>Sku</label>
                <input type="text" class="form-control" name="sku" required="required" placeholder="Masukkan SKU .." value="<?php mysql_connect('192.168.0.100','root','Iz1@dbase'); mysql_select_db('project_inventaris'); $query=mysql_query('select max(barang_id) as id from barang'); $data=mysql_fetch_array($query); $kode=$data['id']; $nourut=(int) substr($kode,3,6); $nourut++; $new="HW".sprintf("%06s", $nourut); echo $new; ?>" >
              </div>
              <div class="form-group">
                <label>Nama</label>
