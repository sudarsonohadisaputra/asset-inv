...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Barang
      <small>Barang Keluar Baru</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <section class="col-lg-6 col-lg-offset-3">       
        <div class="box box-info">
          ...
          <div class="box-header">
            <h3 class="box-title">Barang Keluar Baru</h3>
            ...
            <form action="barang_keluar_act.php" method="post">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="barang" required="required" placeholder="Masukkan Nama .." value="<?php echo $d['brg_nama'] ?>">
                </div>

                <div class="form-group">
                  <label>Serial No</label>
                  <input type="text" class="form-control" name="serial" required="required" placeholder="Masukkan Serial No .." value="<?php echo $d['serial_no'] ?>">
                </div>
                ...
                <div class="form-group">
                  <label>Jumlah</label>
                  <input type="number" class="form-control" name="jumlah" required="required" placeholder="Masukkan jumlah .." value="1">
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                  <input type="hidden" class="form-control" name="approval" required="required" placeholder="Masukkan Approval ..">
                </div>
