...
$jumlah = $_POST['jumlah'];
$lokasi = $_POST['lokasi'];
$lok = mysqli_query($koneksi,"select * from lokasi where lokasi_nama='$lokasi'");
$loknama = mysqli_fetch_assoc($lok);
$idlokasi = $loknama['lokasi_id'];
...
if($jumlah > $kembalikan_jumlah){
	...
	mysqli_query($koneksi,"update barang_keluar set bk_id_barang='$barang', bk_nama_barang='$nama_barang', bk_tgl_keluar='$tanggal', bk_jumlah_keluar='$jumlah', bk_lokasi='$lokasi',bk_id_lokasi='$idlokasi',bk_keterangan='$keterangan' where bk_id='$id'");
