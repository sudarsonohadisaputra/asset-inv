            ...
            <form action="barang_keluar_update.php" method="post">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="noinv" required="required" placeholder="No Inventaris" value="<?php echo $d['bk_id'] ?>" disabled="disabled">
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control" name="lokasi" required="required">
                      <option value="<?php echo $d['bk_lokasi']; ?>"> <?php echo $d['bk_id_lokasi']." ".$d['bk_lokasi']; ?> </option>
                      <?php 
                      $lokasi = mysqli_query($koneksi,"SELECT * from lokasi");
                      while($b=mysqli_fetch_array($lokasi)){
                        ?>
                        <option value="<?php echo $b['lokasi_nama']; ?>"><?php echo $b['lokasi_id']." ".$b['lokasi_nama']; ?></option>
                        <?php 
                      }
                      ?>
                    </select>
