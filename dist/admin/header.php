...
<head>
  ...
  <title>Administrator - Inventaris Izone Indonusa</title>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="barang_wh.php">
              <i class="fa fa-folder"></i> <span>STOCK GUDANG</span>
            </a>
          </li>

          <li>
            <a href="barang.php">
              <i class="fa fa-folder"></i> <span>DATA BARANG STOCK</span>
            </a>
          </li>

          <li>
            <a href="barang_aktif.php">
              <i class="fa fa-folder"></i> <span>DATA BARANG AKTIF</span>
            </a>
          </li>

          <li>
            <a href="barang_bekas.php">
              <i class="fa fa-folder"></i> <span>DATA BARANG BEKAS</span>
            </a>
          </li>
          ...
          <li>
            <a href="mutasi.php">
              <i class="fa fa-mail-forward"></i> <span>MUTASI BARANG</span>
            </a>
          </li>

          <li>
            <a href="barang_sku.php">
              <i class="fa fa-folder"></i> <span>MASTER SKU</span>
            </a>
          </li>
          ...
          <li>
            <a href="lokasi.php">
              <i class="fa fa-truck"></i> <span>DATA LOKASI</span>
            </a>
          </li>
