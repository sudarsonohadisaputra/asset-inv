    ...
    <div class="row">
      <section class="col-lg-6 col-lg-offset-3">       
        <div class="box box-info">
          ...
          <div class="box-body">
            <form action="barang_aktif_update.php" method="post">
              <?php 
              $id = $_GET['id'];              
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  <label>Qty</label>
                  <input type="number" class="form-control" name="jumlah" required="required" placeholder="Masukkan jumlah .." value="<?php echo $d['qty'] ?>">
                </div>
